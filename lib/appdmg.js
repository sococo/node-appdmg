...
module.exports = exports = function (options) {
  ...
  pipeline.addStep('Making all the visuals', function (next) {
    ...
    // See: https://github.com/LinusU/node-appdmg/issues/45#issuecomment-95142726
    // We may want to move this really far to the right to avoid seeing hidden files in they are enabled
    // ..At least they will all be out of the way and on top of each other
    ds.setIconPos('.VolumeIcon.icns', 0, 0);
    ds.setIconPos('.background', 0, 0);
    ds.setIconPos('.DS_Store', 0, 0);
    ds.setIconPos('.Trashes', 0, 0);
